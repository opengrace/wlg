    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">wlg</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/deviceses">
            <ListItem button key="Devices">
              ...
              <ListItemText className="menu-text" primary="Devices" />
            </ListItem>
          </Link>{" "}            
           <Link to="/gpses">
            <ListItem button key="GPS">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="GPS" />
            </ListItem>
          </Link>{" "}            
           <Link to="/sims">
            <ListItem button key="Sim">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Sim" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
